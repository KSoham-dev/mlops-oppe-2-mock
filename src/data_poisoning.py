...
artifact_location = (
    "gs://mlops-course-clean-vista-473214-i6/mlflow-assets/iris-classifier-model"
)
...
def train_with_corruption(corruption_level):
    ...
    run_name = (
        ...
        else f"Poisoned_{int(corruption_level*100)}pct"
    )
    ...
    mlflow.sklearn.autolog(
        max_tuning_runs=10, registered_model_name=None  # Don't register poisoned models
    )
